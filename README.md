...
ROS 2 pacage template, to get started, use template by clicking on the Green button labeled [`Use this template`](https://github.com/zsedelypeter/zse_exn_ajr/generate) / [`Create new repository`](https://github.com/zsedelypeter/zse_exn_ajr/generate). 
...
- your ROS 2 repo shold be `zse_exn_ajr`

Replace everything in the cloned repo:

- `zse_exn_ajr` >> `zse_exn_ajr` (the folder was already renamed after `Use this template`)
- `zsedelypeter` >> `mycoolusername`
